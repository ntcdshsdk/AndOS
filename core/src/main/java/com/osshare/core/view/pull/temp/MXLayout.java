...
public class MXLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = MXLayout.class.getSimpleName();
     ...
     * @param context
     */
    public MXLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public MXLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        Log.i(LOG_TAG, "canChildScrollUp-->" + canChildScrollUp());
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE: {
                Log.i(LOG_TAG, "ACTION_MOVE-->" + canChildScrollUp());
                ...
                if (mIsBeingDragged) {
                    ...
                    } else if(overscrollTop < 0){
                        setTargetOffset((int) overscrollTop,true);
                    } else {
                        return false;
                    }
                }
    ...
    private void setTargetOffset(int overScroll, boolean requiresUpdate) {
