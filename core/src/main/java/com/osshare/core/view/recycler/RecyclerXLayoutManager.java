 ...
 */
public class RecyclerXLayoutManager extends RecyclerView.LayoutManager {
//    @Override
...
//    }
    ...
    final RecyclerXLayoutManager self = this;
     ...
     */
    public RecyclerXLayoutManager(@Orientation int orientation, int itemLineCount) {
     ...
     */
    public RecyclerXLayoutManager setCanScrollHorizontal(boolean canScrollHorizontal) {
     ...
     */
    public RecyclerXLayoutManager setCanScrollVertical(boolean canScrollVertical) {
    ...
    public RecyclerXLayoutManager setOrientation(@Orientation int orientation) {
    ...
    public RecyclerXLayoutManager setItemLineCount(int itemLineCount) {
        assertNotInLayoutOrScroll(null);
