...
public class SwipRefreshLayout extends ViewGroup {
    private static final String LOG_TAG = SwipRefreshLayout.class.getSimpleName();
    ...
    private PullProgressBar mProgressBarBottom;
...
//            }
     ...
     * @param attrs
     */
    public SwipRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mProgressBar = new PullProgressBar(this);
        mProgressBarBottom = new PullProgressBar(this);
