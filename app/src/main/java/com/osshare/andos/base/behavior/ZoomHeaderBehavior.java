package com.osshare.andos.base.behavior;
...
public class ZoomHeaderBehavior extends CoordinatorLayout.Behavior<View>{
    ...
    private void changeView(View child, View dependency, ViewPager viewPager, int i) {
        ...
        View target = null;//v.findViewById(R.id.linearLayout);
        View img = null;//v.findViewById(R.id.imageView);
        View bottom = null;//v.findViewById(R.id.ll_bottom);
        View buyButton = null;//v.findViewById(R.id.btn_buy);
        View nameTxt = null;//v.findViewById(R.id.tv_name);
        View costText = null;//v.findViewById(R.id.tv_cost);
        View left = null;
